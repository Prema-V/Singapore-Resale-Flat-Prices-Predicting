...
if select == "Home":
    img= Image.open(r"home1.png")
    st.image(img)

    st.header("HDB(Housing and Development Board) Flats:")
    ...
    if button:
        ...
        print(year, town, flat_type, flr_area_sqm, flat_model,stry_start, stry_end, re_les_year, re_les_month, les_coms_dt)
